...
<div class="py-12">
    <div class="flex flex-col justify-center items-center bg-white shadow rounded-lg p-6">
        <form method="post" action="{{ route('groups-store') }}" class="w-1/2 grid lg:grid-rows-2 gap-6">
            @csrf
            <h1 class="font-semibold text-xl text-gray-800 leading-tight">Crie um grupo</h1>
            ...
            <div class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
                ...
                <p>
                    <input id="name" name="name" autocomplete="false" tabindex="0" type="text" class="border-none focus:outline-none py-1 px-1 text-gray-900 outline-none block h-full w-full">
                </p>
            </div>
